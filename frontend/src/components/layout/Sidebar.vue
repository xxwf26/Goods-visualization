...
import { HomeFilled, Monitor, FolderOpened, Money, Coin, Sunny, WarningFilled, Shop, Setting, Upload, Collection, Lock, Tickets, DataAnalysis, DataLine, MagicStick, Promotion } from '@element-plus/icons-vue'
