...
ALTER TABLE supplier ADD COLUMN cooperation_status VARCHAR(20) DEFAULT 'potential' COMMENT '合作状态' AFTER shipping_fee;
...
ALTER TABLE inspiration ADD COLUMN collection_status VARCHAR(20) DEFAULT 'uncollected' COMMENT '状态' AFTER collector;
